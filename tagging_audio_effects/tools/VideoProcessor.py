...
# INPUT_VIDEO_PATH = "sample_redhen_files/" #"/mnt/rds/redhen/gallina/tv/2022"
...
class VideoProcessor:
    ...
    def extract_audio(self, video_file, input_video_path, output_audio_file, output_ext, logs):
        subprocess.call([self.cmd, "-i", input_video_path, "-vn", "-f", output_ext, "-ar", "16000",
        ...
        if logs:
            ...
            print("Generation of audio files complete for ", video_file)
    ...
    def extract_audio_files(self, video_input_folder_path, audio_output_folder_path,
        ...
        for dirpath, dirnames, filenames in os.walk(video_input_folder_path):
            ...
            for filename in [f for f in filenames if f.endswith("." + video_file_extensions)]:
                ...
                self.extract_audio(filename, input_file_name, output_file_name, output_ext, logs)

if __name__ == '__main__':
    vp = VideoProcessor()
    print("Starting generation of audio files from ", INPUT_VIDEO_PATH, " to ", OUTPUT_AUDIO_PATH
          + " with format " + OUTPUT_AUDIO_FORMAT)
    vp.extract_audio_files(INPUT_VIDEO_PATH, OUTPUT_AUDIO_PATH, INPUT_VIDEO_FORMAT, OUTPUT_AUDIO_FORMAT, LOGS)
